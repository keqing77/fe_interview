...
不能再离线的情况下使用 svn。如果服务器出现问题, 我们就没有办法使用 svn 来提交我们的代码。
...
1. 可以使用 `git stash`,
2. `git checkout 分支名` 切换分支修复 bug,
3. 修复完成后，再切回来使用 `git stash pop`
